...
class Storage:
    ...
    def __basic_information(self):
        ...
        """
        sample_information = {'name': self.__original_name__, 'extension': self.__original_extension__, 'file_size': '', 'file_size_readable': ''}
    ...
    def __hash_calculation(self):
        ...
        """
        hash_iden = {'md5sum': None, 'sha1sum': None, 'sha256sum': None} 
    ...
    def __extract_macro(self):
        ...
        was_success, macro_code = _object_extract_macro.do_macro_extraction(file_location)
        if was_success:
            return macro_code
        else:
            return ''
    ...
    def __process_modules(self):
        ...
        """
        print(self.__temporary_location__)
